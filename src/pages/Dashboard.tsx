...
import { Plus, Activity, ChevronRight, LogOut, Sparkles, TrendingUp, Clock, Heart, Users, FileText } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      ...
      >
        <div className="health-gradient px-5 pt-14 pb-20 relative">
          {/* Decorative circles */}
          ...
          <div className="flex items-center justify-between mb-8 relative z-10">
            ...
            >
              <p className="text-primary-foreground/60 text-sm font-medium">Good day,</p>
        ...
        >
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <motion.div
                key={label}
                className="glass-card rounded-2xl px-3 py-4 text-center shadow-soft"
      ...
      {/* Bottom nav */}
      <nav className="fixed bottom-0 left-0 right-0 bg-card/90 backdrop-blur-xl border-t border-border/50 px-6 py-3 flex justify-around max-w-lg mx-auto z-50 safe-area-bottom">
        <button className="flex flex-col items-center gap-1 text-primary relative py-1">
        ...
        <button
          onClick={() => navigate("/insights")}
          className="flex flex-col items-center gap-1 text-muted-foreground relative py-1"
        >
          <div className="h-8 w-8 rounded-xl flex items-center justify-center relative">
            ...
            {alertCount > 0 && (
              ...
              >
                <span className="text-[8px] font-bold text-destructive-foreground">{alertCount}</span>
              </motion.div>
            )}
          </div>
